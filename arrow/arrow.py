...
def skia_draw_arrow(image, x0, y0, x1, y1, tip_width=15,tip_height=15,tip_dimple=5, color='black', **skia_kwargs):
    ...
    image = skia_draw_contours(image,arrow.full,**skia_kwargs)
